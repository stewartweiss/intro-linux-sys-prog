/*****************************************************************************
  Title          : test_get_int.c
  Author         : Stewart Weiss
  Created on     : Feb. 20, 2023
  Description    : Shows the effect of get_int()'s flags
  Purpose        : To test the get_int() function
  Usage          : test_get_int  <str>
  Build with     : gcc -g -Wall -o test_get_int -I../include -L../lib \
                      test_get_int.c -lspl
...
int  main(int argc, char *argv[])
{
    ...
    flags = NO_TRAILING;
    printf("flags = %d\n ", flags);
    res =  get_int(argv[1], flags, &number, msg );
