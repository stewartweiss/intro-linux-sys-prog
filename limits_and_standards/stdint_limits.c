...
int main ()
{
    ...
    printf("Minimum values of fastest minimum-width signed integer types = %20d\n",
    INT_FAST32_MIN );
#endif

#if defined  UINT_FAST32_MAX        
    printf("Maximum values of fastest minimum-width signed integer types = %20ud\n",
    UINT_FAST32_MAX );
#endif

    printf("Minimum value of pointer-holding signed integer type = %20d\n",
    INTPTR_MIN );

    printf("Maximum value of pointer-holding signed integer type = %20d\n",
    INTPTR_MAX );

    printf("Maximum value of pointer-holding unsigned integer type = %20ud\n",
    UINTPTR_MAX );
    ...
    printf("Maximum value of greatest-width unsigned integer type = %20llu\n",
    UINTMAX_MAX );
    return 0;
}
