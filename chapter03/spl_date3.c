...
/* A time adjustment string is a sequence of one or more pairs of the form
    <num>  <time_unit>
...
int  main(int argc, char *argv[])
{
    ...
    /* optind-1 is the number of valid options found, so argc-(optind-1) is
       the number of non-option words on the command line, implying that if
